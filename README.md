...
|---|---|---|
| Makro Menü | Yüzen iki katmanlı menü; ilk kategori "Dışa aktar": sayfayı Markdown / metin / HTML olarak kopyalar veya indirir | [kur](https://raw.githubusercontent.com/imbat12/browser-tampermonkey/main/makro-menu.user.js) |
| Döviz TL | Sayfadaki Euro ve dolar (USD, CAD, AUD, HKD, NZD) fiyatlarının arkasına güncel kurla TL karşılığını ekler | [kur](https://raw.githubusercontent.com/imbat12/browser-tampermonkey/main/doviz-tl.user.js) |
